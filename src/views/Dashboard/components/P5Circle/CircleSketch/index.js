...
function base(s) {
  ...
  s.draw = function () {
    ...
    //top 100 line
    s.strokeWeight(2);
    s.line(bx * 0.15, by * 0.2, bx * 0.85, by * 0.2);
    //top 50 line
    s.strokeWeight(1);
    s.line(bx * 0.15, by * 0.35, bx * 0.85, by * 0.35);
    //mid line
    s.strokeWeight(0.5);
    s.line(bx * 0.15, by * 0.5, bx * 0.85, by * 0.5);
    //bot 50 line
    s.strokeWeight(1);
    s.line(bx * 0.15, by * 0.65, bx * 0.85, by * 0.65);
    //bot 100 line
    s.strokeWeight(2);
    s.line(bx * 0.15, by * 0.8, bx * 0.85, by * 0.8);

    //text
    s.strokeWeight(0);
    s.textSize(16);
    s.textAlign("RIGHT", "CENTER");
    s.text("100%", bx * 0.05, by * 0.2 + 7);
    s.text("50%", bx * 0.05, by * 0.35 + 7);
    s.text("0%", bx * 0.05, by * 0.5 + 7);
    s.text("50%", bx * 0.05, by * 0.65 + 7);
    s.text("100%", bx * 0.05, by * 0.8 + 7);
